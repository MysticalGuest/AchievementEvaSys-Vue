  ...
  <div class="center">
    ...
    <el-card class="formatindex" v-if="showindex">
      <el-row>
        ...
        <el-col :span="10">
          <el-upload
            ...
            class="upload-demo"
            ref="upload"
            action="domain:8000/indexTemplate/"
      ...
      <el-table ref="filterTable" :data="tableData.slice((currentPage-1) * pagesize, currentPage * pagesize)" style="width: 100%">
        ...
        <el-table-column prop="index_content" label="毕业要求内容"></el-table-column>
      ...
      <div style="text-align: center;margin-top: 20px;">
        ...
        <el-dialog width="30%" title="添加毕业要求" :visible.sync="outerVisible" append-to-body>
          <p>输入新的毕业要求的名称</p>
          <el-input type="textarea" :autosize="{ minRows: 1, maxRows: 10}" v-model="newIndexDetailName">
          </el-input>
  ...
  export default {
    data() {
      return {
        ...
        tableData: [],
        outerVisible: false,
        newIndexDetailName:'',   // 新的毕业要求的名称
        newIndexDetailContent:'',   // 新的毕业要求的内容
    ...
    methods: {
      ...
      */
      ...
      submit(){
        ...
        SPApi.submitIndex(this.newIndexDetailName, this.newIndexDetailContent).then(res=>{
          if(res.message == "success" && this.newIndexDetailName != "" && this.newIndexDetailContent != ""){
            this.$notify({
              title: '成功',
              message: '毕业要求已录入！',
              type: 'success'
            ...
            this.getIndex()
          } else if(this.newIndexDetailName == "" && this.newIndexDetailContent == ""){
            this.$notify.error({
              title: '失败',
              message: '内容不能为空',
            });
